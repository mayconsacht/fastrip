...
trip = Trip.create(name: "XXXperience", origin: "Jaraguá do Sul", destination: "Curitiba", price: 25.10, in_date: "2015-11-08", out_date: "2015-11-12")
Trip.create(name: "Tribaltech", origin: "Jaraguá do Sul", destination: "Curitiba", price: 25.10, in_date: "2015-11-10", out_date: "2015-11-20")
Trip.create(name: "Tribaltech", origin: "Jaraguá do Sul", destination: "Curitiba", price: 25.10, in_date: "2015-11-01", out_date: "2015-11-02")
